...
> **Historical (Databricks era).** This finding predates the Snowflake migration and the retirement of the Databricks stack on 2026-07-25; `infra/grants.tf` no longer exists. Kept because the lesson -- authoritative IaC grants revoke undeclared drift as a side effect -- is what justified the RBAC posture the Snowflake stack inherited.
