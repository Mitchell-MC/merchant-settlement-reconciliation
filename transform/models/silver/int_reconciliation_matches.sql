...
single_matches as (
    select
        ...
        array_construct(posting_id) as matched_posting_ids,
...
split_candidates as (
    select
        ...
        array_agg(c.posting_id) as posting_ids,
...
select
    ...
    coalesce(m.matched_posting_ids, br.matched_posting_ids, array_construct()) as matched_posting_ids,
